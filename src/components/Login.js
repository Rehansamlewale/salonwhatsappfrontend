                ...
                <div className="hidden lg:flex w-1/2 bg-[#C4D2F5] flex-col justify-center items-center p-12 relative overflow-hidden">
                    ...
                    <div className="relative z-10 mb-8 transform hover:scale-105 transition-transform duration-500">
                        <div className="w-64 h-64 bg-white rounded-full flex items-center justify-center shadow-lg p-2">
                            <img src="/whatsapp_logo.png" alt="Whatsapp connection" className="w-full h-full rounded-full object-cover" />
                        </div>
                    </div>

                    <div className="relative z-10 text-center max-w-sm">
                        <h2 className="text-3xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-green-700 to-green-600 mb-2 tracking-tight drop-shadow-sm">
                            Whatsapp connection
                        </h2>
                    ...
                    <div className="w-full max-w-sm space-y-6">
                        ...
                        <div className="text-center lg:text-left">
                            <div className="flex items-center justify-center lg:justify-start gap-2 mb-2">
                                <img src="/whatsapp_logo.png" alt="Whatsapp connection" className="w-24 h-24 rounded-full object-cover" />
                            </div>
