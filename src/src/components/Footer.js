                ...
                <div className="max-w-7xl mx-auto px-6 py-4">
                    <div className="flex flex-col md:flex-row justify-between items-center gap-3">
                        ...
                        <p className="text-gray-400 text-sm">
                            © {currentYear} <span className="text-primary-400 font-semibold">Loan Management System</span>. All rights reserved.
                        </p>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
                            ...
                            <div className="space-y-6">
                                <div className="flex items-center space-x-4">
                                    ...
                                    />
                                    <div>
                                        <h3 className="text-xl font-bold text-white leading-tight">Loan</h3>
                                        <p className="text-primary-300 text-sm font-semibold">Financial Services</p>
                                    </div>
                                </div>
                                <p className="text-gray-400 text-sm leading-relaxed">
                                    Your trusted finance partner for seamless loan document management and professional financial services.
                                </p>
