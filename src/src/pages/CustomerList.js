...
const CustomerList = () => {
    ...
    const [hideRecentlyMessaged, setHideRecentlyMessaged] = useState(true);
    ...
    const getAllCustomers = async () => {
        try {
            ...
            const customersList = Object.entries(data).map(([key, customerData]) => {
                ...
                return {
                    id: customerData.customerId || key,
                    name: basic.full_name || customerData.dealerName || '',
                    mobile1: basic.mobile || customerData.mobile1 || '',
                    ...
                    createdAtTimestamp: createdAtDate.getTime(), // Add timestamp for stable sorting
            ...
            // Sort by timestamp in descending order (latest first), with ID as tiebreaker for stability
            let list = customersList.sort((a, b) => {
                ...
                // If timestamps are equal, sort by ID for stable sort
                ...
                <div className="animate-fadeIn">
                    <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
                        <div className="flex items-center gap-4">
                            <h3 className="text-2xl font-bold text-gray-800">All Customers ({customers.length})</h3>
                        </div>
